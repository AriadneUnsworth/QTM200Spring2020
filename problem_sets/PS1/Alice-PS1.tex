...
\begin{document}
	...
	\lstinputlisting[language=R, firstline=42, lastline=52]{PS1.R}
	...
	\vspace{.5cm}
	\lstinputlisting[language=R, firstline=57, lastline=57]{PS1.R}  
	\vspace{.5cm}
	...
	\vspace{.5cm}
	\lstinputlisting[language=R, firstline=58, lastline=60]{PS1.R} 
	...
	\vspace{.5cm}
	\lstinputlisting[language=R, firstline=66, lastline=66]{PS1.R}  
	\vspace{.5cm}
	\begin{itemize}		
		\item
