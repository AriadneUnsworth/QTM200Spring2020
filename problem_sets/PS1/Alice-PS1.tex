...
\begin{document}
	...
	\lstinputlisting[language=R, firstline=40, lastline=40]{Alice-PS1.R}
	...
	\lstinputlisting[language=R, firstline=42, lastline=51]{Alice-PS1.R}
	...
	\vspace{.5cm}
	\lstinputlisting[language=R, firstline=57, lastline=57]{Alice-PS1.R}  
	\vspace{.5cm}
	...
	\vspace{.5cm}
	\lstinputlisting[language=R, firstline=57, lastline=60]{Alice-PS1.R} 
	...
	\vspace{.5cm}
	\lstinputlisting[language=R, firstline=66, lastline=66]{Alice-PS1.R}  
	\vspace{.5cm}
	\begin{itemize}		
		\item
		...
		\vspace{.5cm}        
		\lstinputlisting[language=R, firstline=70, lastline=109]{Alice-PS1.R}		
