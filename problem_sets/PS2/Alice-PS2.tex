...
\begin{enumerate}
	...
	\lstinputlisting[language=R, firstline=4, lastline=14]{Alice-PS2.R}
	\item [(b)]
	\vspace{1cm}
	...
	\lstinputlisting[language=R, firstline=18, lastline=24]{Alice-PS2.R}
	\newpage
	...
	\lstinputlisting[language=R, firstline=26, lastline=37]{Alice-PS2.R}
...
\begin{enumerate}
	...
	\lstinputlisting[language=R, firstline=41, lastline=49]{Alice-PS2.R}
	\vspace{.5cm}
...
\begin{enumerate}
	...
	\lstinputlisting[language=R, firstline=52, lastline=56]{Alice-PS2.R}
	\begin{figure}[h!]
		\label{Q2}
...
\newpage
	...
	\end{figure}
	\lstinputlisting[language=R, firstline=57, lastline=61]{Alice-PS2.R}
	\vspace{.5cm}	
	\item
	Regress \texttt{lifespan} on \texttt{thorax}.  Interpret the slope of the fitted model.
	
	\lstinputlisting[language=R, firstline=62, lastline=67]{Alice-PS2.R}
	\begin{Verbatim}
	Coefficients:
	...
	\end{Verbatim}
	\lstinputlisting[language=R, firstline=68, lastline=70]{Alice-PS2.R}
\newpage
	\item
	...
	\begin{itemize}
		...
		\lstinputlisting[language=R, firstline=72, lastline=75]{Alice-PS2.R}
		The resulting confidence interval is (124.0108, 164.6492)
		\vspace{.5cm}
		\item
		Now, try using the function  \texttt{confint()}  in \texttt{R}.
		\lstinputlisting[language=R, firstline=76, lastline=77]{Alice-PS2.R}		
	\end{itemize}
			\vspace{1cm}
	...
	\lstinputlisting[language=R, firstline=79, lastline=83]{Alice-PS2.R}
		Result:
	\begin{Verbatim}
       fit      lwr      upr
	...
	\lstinputlisting[language=R, firstline=85, lastline=94]{Alice-PS2.R}
